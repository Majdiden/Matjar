...
export const heroShowcaseSection: SectionDefinition = defineSection({
  ...
  limit: 1,
  settings: [
    { id: 'sidebar_heading', type: 'text', label: 'Sidebar Heading', default: 'BROWSE ALL COLLECTION' },
    { id: 'max_categories', type: 'number', label: 'Max Categories', default: 10, min: 4, max: 14 },
    { id: 'hotline_label', type: 'text', label: 'Hotline Label', default: 'HOTLINE' },
    { id: 'hotline_phone', type: 'text', label: 'Hotline Phone', default: '+1 (555) 456-7890' },
    { id: 'shipping_strip', type: 'text', label: 'Shipping Strip', default: 'FREE SHIPPING FOR ORDER ABOVE $200. SHOP NOW' },
    { id: 'eyebrow', type: 'text', label: 'Spotlight Eyebrow', default: 'SMART SPEAKER' },
    { id: 'heading_line1', type: 'text', label: 'Spotlight Heading Line 1', default: 'WIRELESS' },
    { id: 'heading_line2', type: 'text', label: 'Spotlight Heading Line 2', default: 'SPEAKERS' },
    ...
    { id: 'flash_deal_label', type: 'text', label: 'Flash Deal Label', default: 'FLASH DEAL' },
  ...
  blocks: [
    {
      ...
      settings: [
        ...
        { id: 'subtitle', type: 'text', label: 'Subtitle', default: 'For US customers above $200' },
      ],
    },
  ],
  defaultBlocks: [
  ...
  blocks: [
    {
      ...
      settings: [
        ...
        { id: 'title', type: 'text', label: 'Title', default: 'PC GAMING' },
        { id: 'subtitle', type: 'text', label: 'Subtitle', default: 'PREMIUM PERFORMANCE' },
...
export const categorySidebarSection: SectionDefinition = defineSection({
  ...
  limit: 1,
  settings: [
    { id: 'eyebrow', type: 'text', label: 'Eyebrow', default: 'Shop by department' },
    { id: 'heading', type: 'text', label: 'Heading', default: 'Find what you need, fast' },
    { id: 'max_categories', type: 'number', label: 'Max Categories', default: 8, min: 3, max: 12 },
    { id: 'view_all_text', type: 'text', label: 'View All Text', default: 'All categories' },
  ],
});
...
const manifest = defineTheme({
  ...
  settings: [
    ...
    { id: 'announcement_text', type: 'text', label: 'Announcement Text', default: 'Free express shipping on orders over $200!' },
