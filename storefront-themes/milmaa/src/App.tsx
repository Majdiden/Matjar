...
const renderMilmaaCard = (product: any, onQuickView?: (p: any) => void) => (
  <MilmaaProductCard product={product} onQuickView={onQuickView} />
);

function App() {
  return (
    <ThemeCardProvider renderCard={renderMilmaaCard}>
      <ScrollToTop />
      <Routes>
