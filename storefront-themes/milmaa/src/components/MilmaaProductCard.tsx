    ...
    <div className="group relative">
      <Link to={`/products/${slug}`} className="block">
        ...
        >
          ...
          {/* Wishlist heart — milmaa's rounded white treatment */}
          <div className="absolute bottom-4 end-4 z-10">
            <WishlistButton
              ...
              renderIcon={(active) => (
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={1.8} style={{ color: 'var(--color-foreground)' }}>
