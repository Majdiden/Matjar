  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <nav className="text-sm text-gray-500 mb-6">
        <Link to="/" className="hover:text-gray-700">{t('theme.nav.home')}</Link>
          ...
          {requiresVariantSelection ? (
            ...
            <div className="mb-6">
              <p className="text-sm text-amber-600">
                {t('theme.product_detail.preorder', { defaultValue: 'Pre-order' })}{shipDateLabel ? ` — ${t('theme.product_detail.ships_on', { defaultValue: 'ships {{date}}', date: shipDateLabel })}` : ''}
              </p>
              {preState.lowRemaining && preState.remaining !== null && (
                <p className="text-xs font-semibold text-amber-700 mt-1">{t('theme.product_detail.only_left', { defaultValue: 'Only {{count}} left', count: preState.remaining })}</p>
              )}
