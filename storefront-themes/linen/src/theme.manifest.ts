...
export const heroSection: SectionDefinition = defineSection({
  ...
  defaultBlocks: [
    { id: 'slide-1', type: 'slide', settings: { image: U('1556228720-195a672e8a03'), eyebrow: 'Daily rituals', heading: 'Skin that feels rested, every morning', body: 'Gentle formulas built around a few honest ingredients. Nothing you don’t need, everything you do.', cta_text: 'Shop the ritual', cta_url: '/products' } },
    { id: 'slide-2', type: 'slide', settings: { image: U('1570554886111-e80fcca6a029'), eyebrow: 'New season', heading: 'A calmer routine for warmer days', body: 'Lightweight moisture, mineral sun care and a mist you will keep in your bag.', cta_text: 'See what’s new', cta_url: '/products?sort=newest' } },
    { id: 'slide-3', type: 'slide', settings: { image: U('1608248543803-ba4f8c70ae0b'), eyebrow: 'Made with care', heading: 'Small batches. Clear labels. Real results.', body: 'Every jar is filled by hand and dated, so what reaches you is as fresh as it should be.', cta_text: 'Our story', cta_url: '/about' } },
  ],
});
...
export const supportStripSection: SectionDefinition = defineSection({
  ...
  defaultBlocks: [
    { id: 'ti-1', type: 'trust-item', settings: { icon: 'truck', title: 'Shipping', text: 'Free delivery on orders over the threshold' } },
    { id: 'ti-2', type: 'trust-item', settings: { icon: 'headset', title: 'Here to help', text: 'Real people, every day of the week' } },
    { id: 'ti-3', type: 'trust-item', settings: { icon: 'return', title: 'Easy returns', text: '30 days to change your mind' } },
    { id: 'ti-4', type: 'trust-item', settings: { icon: 'leaf', title: 'Clean formulas', text: 'Fragrance-free, never tested on animals' } },
  ],
});
...
export const productGridSection: SectionDefinition = defineSection({
  ...
  target: 'body',
  settings: [
    { id: 'eyebrow', type: 'text', label: 'Eyebrow', default: 'Loved by many' },
    { id: 'heading', type: 'text', label: 'Heading', default: 'Everyday essentials' },
    ...
    { id: 'view_all_text', type: 'text', label: 'View All Button Text', default: 'View all' },
...
export const promoBannerSection: SectionDefinition = defineSection({
  ...
  settings: [
    ...
    { id: 'heading', type: 'text', label: 'Heading', default: 'A little extra this weekend' },
    { id: 'body', type: 'textarea', label: 'Body', default: 'Complimentary gift wrapping and a travel-size mist with every order over the free-shipping threshold. Applied automatically at checkout.' },
...
export const categoryMasonrySection: SectionDefinition = defineSection({
  ...
  limit: 1,
  settings: [
    { id: 'eyebrow', type: 'text', label: 'Eyebrow', default: 'Find your fit' },
    { id: 'heading', type: 'text', label: 'Heading', default: 'Shop by category' },
    { id: 'cta_text', type: 'text', label: 'CTA Text', default: 'Explore' },
...
export const editorialSplitSection: SectionDefinition = defineSection({
  ...
  settings: [
    ...
    { id: 'eyebrow', type: 'text', label: 'Eyebrow', default: 'Rich in vitamin C' },
    { id: 'heading', type: 'text', label: 'Heading', default: 'Creams that feel like a deep breath' },
    { id: 'body', type: 'textarea', label: 'Body', default: 'We start with cold-pressed plant oils and add only what the skin barrier asks for. The result sinks in fast, leaves no film, and lets your skin get on with its day.' },
    { id: 'cta_text', type: 'text', label: 'CTA Text', default: 'Shop face care' },
    { id: 'cta_url', type: 'url', label: 'CTA URL', default: '/products' },
    ...pad(),
  ],
});
...
export const testimonialsSection: SectionDefinition = defineSection({
  ...
  limit: 1,
  settings: [
    { id: 'eyebrow', type: 'text', label: 'Eyebrow', default: 'Kind words' },
    { id: 'heading', type: 'text', label: 'Heading', default: 'What people tell us' },
    ...pad(),
  ],
  blocks: [
    {
  ...
  defaultBlocks: [
    { id: 'tm-1', type: 'testimonial', settings: { quote: 'The night cream is the first one that never stung. Two weeks in, my cheeks stopped flaking.', name: 'Rana', role: 'Khartoum' } },
    { id: 'tm-2', type: 'testimonial', settings: { quote: 'Ordered on a Tuesday, had it by Thursday, and the jar was dated the week before. That matters to me.', name: 'Mazin', role: 'Omdurman' } },
    { id: 'tm-3', type: 'testimonial', settings: { quote: 'Finally a sunscreen that doesn’t leave a white cast on my skin. I wear it every single day now.', name: 'Salma', role: 'Port Sudan' } },
    { id: 'tm-4', type: 'testimonial', settings: { quote: 'I bought the mist as a gift and ended up keeping it. The whole family steals it in summer.', name: 'Hiba', role: 'Kassala' } },
  ],
});
...
export const storiesSection: SectionDefinition = defineSection({
  ...
  limit: 1,
  settings: [
    { id: 'eyebrow', type: 'text', label: 'Eyebrow', default: 'From the journal' },
    { id: 'heading', type: 'text', label: 'Heading', default: 'Slow beauty, explained' },
    ...pad(),
  ],
  blocks: [
    {
  ...
  defaultBlocks: [
    { id: 'st-1', type: 'post', settings: { image: U('1552693673-1bf958298935', 1200), date: 'Jun 02', title: 'How to layer a routine without overloading your skin', excerpt: 'Thin to thick, water to oil. A five-minute order of operations that works for every skin type.', link_url: '/about' } },
    { id: 'st-2', type: 'post', settings: { image: U('1601049541289-9b1b7bbbfe19', 1200), date: 'May 19', title: 'Why we date every jar', excerpt: 'Freshness is a feature. Here is what happens to plant oils after opening, and how we keep them stable.', link_url: '/about' } },
    { id: 'st-3', type: 'post', settings: { image: U('1598440947619-2c35fc9aa908', 1200), date: 'May 04', title: 'Sun care for hot, dry climates', excerpt: 'Mineral filters, reapplication that actually happens, and the one product to keep in the car.', link_url: '/about' } },
  ],
});
...
export const instagramSection: SectionDefinition = defineSection({
  ...
  limit: 1,
  settings: [
    { id: 'eyebrow', type: 'text', label: 'Eyebrow', default: 'On Instagram' },
    { id: 'handle', type: 'text', label: 'Handle button text', default: '@yourstore' },
...
const manifest = defineTheme({
  ...
  settings: [
    ...
    { id: 'announcement_text', type: 'text', label: 'Announcement Text', default: 'Free shipping on orders over the threshold' },
    { id: 'announcement_text_2', type: 'text', label: 'Announcement Text 2', default: 'New: mineral sun care for hot days' },
    { id: 'announcement_text_3', type: 'text', label: 'Announcement Text 3', default: 'Every jar filled by hand and dated' },
    { id: 'free_shipping_threshold', type: 'number', label: 'Free shipping threshold', default: 300, min: 0, max: 100000 },
    { id: 'popular_searches', type: 'text', label: 'Popular searches (comma separated)', default: 'Serum, Moisturizer, Sun care, Mist, Cleanser' },
    { id: 'mega_image', type: 'image', label: 'Mega Menu Image', default: U('1616394584738-fc6e612e71b9', 900) },
    { id: 'mega_eyebrow', type: 'text', label: 'Mega Menu Eyebrow', default: 'This month' },
    { id: 'mega_title', type: 'text', label: 'Mega Menu Title', default: 'The barrier repair edit' },
    { id: 'mega_cta_text', type: 'text', label: 'Mega Menu CTA Text', default: 'Shop the edit' },
    ...
    { id: 'footer_about', type: 'textarea', label: 'Footer About Text', default: 'Honest skincare made in small batches. Cream jars, clear labels, and formulas that respect the skin barrier.' },
    { id: 'opening_hours', type: 'text', label: 'Opening hours', default: 'Sat – Thu, 9:00 – 21:00' },
  ],
  ...
  templates: {
    index: [
      ...
      { id: 'grid-1', type: 'linen-product-grid', settings: { eyebrow: 'Loved by many', heading: 'Everyday essentials', product_source: 'featured' } },
      { id: 'promo', type: 'linen-promo-banner', settings: {} },
      { id: 'masonry', type: 'linen-category-masonry', settings: {} },
      { id: 'grid-2', type: 'linen-product-grid', settings: { eyebrow: 'Just landed', heading: 'New this season', product_source: 'newest', view_all_url: '/products?sort=newest' } },
    ...
    product: [
      ...
      { id: 'product-details', type: 'product-details', settings: { show_description: false, show_specs: true, show_content_sections: false, heading: 'Specifications', specs_heading: '' } },
    ],
    collection: [],
    cart: [],
    search: [],
