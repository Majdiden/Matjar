...
const renderGlowingCard = (product: any, onQuickView?: (p: any) => void) => (
  <GlowingProductCard product={product} onQuickView={onQuickView} />
);

function App() {
  return (
    <ThemeCardProvider renderCard={renderGlowingCard}>
      <ScrollToTop />
      <Routes>
