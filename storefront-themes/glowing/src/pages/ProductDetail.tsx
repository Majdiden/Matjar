  ...
  if (error || !product) {
    return (
      <div className="max-w-3xl mx-auto px-6 py-32 text-center">
        <h1 className="font-display text-5xl mb-4" style={{ fontFamily: 'var(--font-family-heading)' }}>Not Found</h1>
        <p className="text-neutral-500 mb-6">We couldn't find that product.</p>
    ...
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-[80px_1fr_420px] gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-xs text-neutral-500">({reviews?.length || 0} reviews)</span>
            </div>
        ...
        <div className="max-w-3xl mx-auto pt-10 pb-16 text-sm text-neutral-700 leading-relaxed">
          ...
          {tab === 'shipping' && (
            <div className="space-y-4">
              <p><strong>Free shipping</strong> on all US orders over $50. International shipping available at checkout.</p>
              <p><strong>30-day returns.</strong> If you're not satisfied, return your order within 30 days for a full refund.</p>
              <p>All orders are processed within 1–2 business days. You'll receive tracking information via email as soon as your order ships.</p>
            </div>
          )}
          {tab === 'reviews' && (
            <ProductReviews
