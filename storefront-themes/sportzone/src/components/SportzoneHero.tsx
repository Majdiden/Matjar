    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[var(--layout-max-width,1280px)] px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
        <div className="max-w-2xl">
          {/* Eyebrow — angular tag */}
          <span
            className="inline-flex items-center gap-2 px-3.5 py-1.5 text-xs sm:text-sm font-black uppercase italic tracking-[0.15em] text-white [clip-path:polygon(8%_0,100%_0,92%_100%,0_100%)]"
