...
export const heroSection: SectionDefinition = defineSection({
  ...
  limit: 1,
  settings: [
    { id: 'heading', type: 'text', label: 'Heading', default: 'Welcome', info: 'Main headline — falls back to store name if empty' },
    { id: 'subheading', type: 'textarea', label: 'Subheading', default: 'Discover amazing products at great prices' },
    { id: 'badge_text', type: 'text', label: 'Badge Text', default: 'New Collection' },
    ...
    { id: 'sale_heading', type: 'text', label: 'Sale Heading', default: 'Season Sale' },
    { id: 'sale_subheading', type: 'text', label: 'Sale Subheading', default: 'Up to 50% off selected items' },
    { id: 'sale_button_text', type: 'text', label: 'Sale Button Text', default: 'Shop the Sale' },
...
export const categoriesSection: SectionDefinition = defineSection({
  ...
  settings: [
    ...
    { id: 'subheading', type: 'text', label: 'Subheading', default: 'Browse our curated collections' },
...
export const featuredProductsSection: SectionDefinition = defineSection({
  ...
  settings: [
    ...
    { id: 'subheading', type: 'text', label: 'Subheading', default: 'Hand-picked for you' },
...
export const newArrivalsSection: SectionDefinition = defineSection({
  ...
  settings: [
    ...
    { id: 'subheading', type: 'text', label: 'Subheading', default: 'Just landed in store' },
...
export const newsletterSection: SectionDefinition = defineSection({
  ...
  settings: [
    ...
    { id: 'subheading', type: 'text', label: 'Subheading', default: 'Subscribe for exclusive deals, new arrivals, and insider offers.' },
