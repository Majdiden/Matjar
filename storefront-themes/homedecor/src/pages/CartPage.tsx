  ...
  if (!cart || cart.items.length === 0) {
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 text-center">
        ...
        <h2 className="text-2xl font-bold mb-2">{t('theme.cart.empty_title')}</h2>
        <p className="text-gray-500 mb-6">{t('theme.cart.empty_subtitle')}</p>
        <Link
          to="/products"
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold">{t('theme.cart.title')}</h1>
        ...
        {cart.items.map((item) => (
          <div key={item.id} className="flex gap-4 p-4 border rounded-lg">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 mt-1">{formatPrice(item.price)} {t('theme.cart.each')}</p>
