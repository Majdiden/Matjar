  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <h1 className="text-3xl font-bold mb-8">
        {category ? categories.find(c => c._id === category)?.name || t('theme.products.title_all') : t('theme.products.title_all')}
      </h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 text-lg">{t('theme.products.empty')}</p>
          {search && (
            <button
